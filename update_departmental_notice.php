...
if (isset($_POST['update_notice'])) {
    ...
    $stmt->execute();
    if ($stmt) {
        $success = "Departmental Notice Updated" && header("refresh:1; url=departmental_notices.php");
    } else {
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Update Departmental Notice</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="departmental_notices.php">Departmental Notice</a></li>
                            ...
                            <div class="card card-primary">
                                ...
                                <form method="post" enctype="multipart/form-data" role="form">
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" name="update_notice" class="btn btn-primary">Update Departmental Notice</button>
                                    </div>
                                </form>
                            </div>
                        </div>
