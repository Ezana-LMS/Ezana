                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-md-4">
                                <a href="departments_reports.php?faculty=<?php echo $row->id; ?>">
                                    <div class="info-box">
                                        <span class="info-box-icon bg-secondary elevation-1"><i class="fa fa-building" aria-hidden="true"></i></span>
                            ...
                            <!-- Courses  -->
                            <div class="col-12 col-sm-6 col-md-4">
                                <a href="courses_reports.php?faculty=<?php echo $row->id; ?>">
                            ...
                            <!-- Modules -->
                            <div class="col-12 col-sm-6 col-md-4">
                                <a href="modules_reports.php?faculty=<?php echo $row->id; ?>">
                                    <div class="info-box mb-3">
                            ...
                            <!-- School Calendar -->
                            <div class="col-12 col-sm-6 col-md-4">
                                <a href="school_calendar_reports.php?faculty=<?php echo $row->id; ?>">
                                    <div class="info-box mb-3">
                                        <span class="info-box-icon bg-secondary elevation-1"><i class="fas fa-calendar-alt"></i></span>
                                        <div class="info-box-content">
