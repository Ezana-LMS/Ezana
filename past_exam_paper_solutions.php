...
if (isset($_GET['delete'])) {
    ...
    $stmt->close();
    if ($stmt) {
        $success = "Deleted" && header("refresh:1; url=past_exam_paper_solutions.php?faculty=$faculty");
    } else {
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <div class="container">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Past Exam Papers Solutions</h1>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h2 class="text-right">
                                                <a class="btn btn-outline-success" href="add_past_exam_paper_solution.php?faculty=<?php echo $row->id; ?>">
                                                    Upload Past Paper Solution
                                                </a>
                                            </h2>
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a class="badge badge-danger" href="past_exam_paper_solutions.php?delete=<?php echo $pastExas->id; ?>&faculty=<?php echo $row->id; ?>">
