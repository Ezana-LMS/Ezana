...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        $view = $_GET['view'];
        $ret = "SELECT * FROM `ezanaLMS_CourseDirectories` WHERE id ='$view'  ";
                    ...
                    <div class="container-fluid">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title">
                                    <?php echo $dir->course_name; ?> Directory Created On <span class='text-success'><?php echo $dir->created_at; ?></span>
                                </h3>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="custom-content-below-tabContent">
                                    <div class="tab-pane fade active" id="custom-content-below-profile" role="tabpanel" aria-labelledby="custom-content-below-profile-tab">
                                        ...
                                        if ($dir->course_materials != '') {
                                            echo
                                                "
                                                <a href='dist/Course_Dir/$dir->course_materials' class='btn btn-outline-success'>
