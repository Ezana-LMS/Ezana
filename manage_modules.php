...
if (isset($_GET['delete'])) {
    ...
    $stmt->close();
    if ($stmt) {
        $success = "Deleted" && header("refresh:1; url=manage_modules.php");
    } else {
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="text-right">
                                    <a class="btn btn-outline-success" href="add_module.php">
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="badge badge-primary" href="update_module.php?update=<?php echo $mod->id; ?>">
                                                        <i class="fas fa-edit"></i>
                                                        Update
                                                    </a>

                                                    <a class="badge badge-danger" href="manage_modules.php?delete=<?php echo $mod->id; ?>">
