...
if (isset($_GET['delete'])) {
    ...
    $stmt->close();
    if ($stmt) {
        $success = "Deleted" && header("refresh:1; url=questions_bank.php");
    } else {
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="badge badge-danger" href="questions_bank.php?delete=<?php echo $exam->id; ?>">
