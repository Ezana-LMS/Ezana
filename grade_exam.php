...
if (isset($_POST['submit_marks'])) {
    ...
    if (!$error) {
        ...
        $stmt1->execute();
        if ($stmt && $stmt1) {
            $success = "Marks Submitted" && header("refresh:1; url=mark_exams.php?exam_id=$exam_id");
        } else {
                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="custom-content-below-profile-tab" data-toggle="pill" href="#custom-content-below-profile" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Grade Exam</a>
                                    </li>
                                </ul>
