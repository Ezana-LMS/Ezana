                    ...
                    <div class="container-fluid">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title">
                                    Update <?php echo $exam->student_name; ?> Marks
                                </h3>
                            </div>
                            <div class="card-body">
                                <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="custom-content-below-home-tab" data-toggle="pill" href="#custom-content-below-home" role="tab" aria-controls="custom-content-below-home" aria-selected="true">Update Marks</a>
                                    </li>
                                </ul>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input type="text" value="<?php echo $exam->marks_attained; ?>" required name="marks_attained" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="card-footer">
                                                    <button type="submit" name="submit_marks" class="btn btn-primary">Udpate Marks</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
