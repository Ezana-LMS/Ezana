...
if (isset($_GET['delete'])) {
    ...
    $stmt->close();
    if ($stmt) {
        $success = "Deleted" && header("refresh:1; url=manage_groups.php");
    } else {
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $ret = "SELECT * FROM `ezanaLMS_Groups`  ";
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="badge badge-danger" href="manage_groups.php?delete=<?php echo $g->id; ?>">
