...
if (isset($_GET['delete'])) {
    ...
    $stmt->close();
    if ($stmt) {
        $success = "Deleted" && header("refresh:1; url=mark_exams.php?exam_id=$exam_id");
    } else {
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Mark Exams</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="text-right">
                                    <a class="btn btn-outline-success" href="upload_exam_attempt.php?exam_id=<?php echo $exam_id; ?>">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="badge badge-success" href="grade_exam.php?grade=<?php echo $exam->id; ?>&exam_id=<?php echo $exam->exam_id; ?>">
                                                        <i class="fas fa-eye"></i>
                                                        Grade Exam
                                                    </a>
                                                    <a class="badge badge-danger" href="mark_exams.php?delete=<?php echo $exam->id; ?>">
