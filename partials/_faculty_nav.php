        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                <a href="dashboard.php" class="navbar-brand">
                    <img src="dist/img/Main_Logo.png" alt="Ezana LMS Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                ...
                <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                       <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="view_faculty.php?faculty=<?php echo $faculty->id; ?>" class="nav-link"><?php echo $faculty->name; ?> Dashboard</a>
                        </li>
                    </ul>
                </div>
                <!-- Right navbar links -->
