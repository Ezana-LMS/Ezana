...
if (isset($_POST['update_reading_materials'])) {
    ...
    if (!$error) {
        ...
        $stmt->execute();
        if ($stmt) {
            $success = "Reading Materials Updated" && header("refresh:1; url=reading_materials.php");
        } else {
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        $update =  $_GET['update'];
        $ret = "SELECT * FROM `ezanaLMS_ModuleRecommended` WHERE id ='$update'  ";
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Update Reading Materials</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">Update Reading Materials</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
