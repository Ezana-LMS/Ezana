...
---------------------*/
    ...
    .alldemo .single_items:hover::after {
        opacity: 1;
    }
...
---------------------*/
    ...
    .indexhtml .single_items:hover .view_text p {
        transform: translateY(0);
    }

    .indexhtml .single_items:hover .view_text h3 {
    ...
    .indexhtml .single_items:hover .view_text a {
        opacity: 1;
    }
